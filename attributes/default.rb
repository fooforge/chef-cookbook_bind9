...
when "centos", "redhat", "fedora", "scientific", "amazon"
  default[:bind9][:config_path]  = "/etc/"
  default[:bind9][:config_file]  = "/etc/named.conf"
  default[:bind9][:options_file] = "/etc/named.conf.options"
  default[:bind9][:local_file]   = "/etc/named.conf.local"
...
when "smartos"
  ...
  default[:bind9][:config_file]  = "/opt/local/etc/named.conf"
